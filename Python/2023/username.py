    ...
    """
    The code checks if a username and password meet specific criteria such as length, presence of
    spaces, numbers, special characters, and capitalized letters.
    
    :param username: The username is a string that represents the username inputted by the user
    """
...
def username_check(username):
    if len(username) <= 4:
        ...
        print(f"Your username {username} got space it in and therefore is invalid!")
