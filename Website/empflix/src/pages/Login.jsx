...
const styles = {
  ...
  loginButton: 'w-full p-2 bg-red-600 rounded text-white hover:bg-red-700 cursor-pointer',
          ...
          <div className={styles.formContainer}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className={styles.notSubscribedText}>
                Not subscribed yet? <Link to='/Signup' className={styles.signupLink}>Sign up</Link>
              </p>
            </form>
          </div>
        </div>
