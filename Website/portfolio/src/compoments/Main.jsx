...
const Main = () => {
  const styles = {
    mainContainer:
      "w-full h-screen absolute inset-0 flex flex-col justify-center items-center bg-white/50",
    contentContainer:
      "max-w-[700px] mx-auto h-full w-full flex flex-col justify-center lg:items-start items-center text-center",
